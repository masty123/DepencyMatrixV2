...
public class Utils {
	...
	public static void recurCa(String path, String folder,PackageInfo info, String outerPackage){
		...
		String[] jcdFiles = jcdFile.list();
		ReadFile read = new ReadFile();
//		System.out.println(path+outerPackage+folder);
//		System.out.println("Files: " + Arrays.toString(jcdFiles));
		for(String myFile : jcdFiles) {
			if(myFile.endsWith(".java")) {
	...
	public static PackageInfo calculate(String packageName, String path, String outerPackage){
		...
		File jcdFileCa = new File(path+outerPackage+info.packageName);
		//Get list of files and store in our array
